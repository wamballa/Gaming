...
class Game extends Phaser.Game {
  constructor() {
    ...
    this.global.canvas_width =
      window.screen.availWidth * window.devicePixelRatio;

    this.global.canvas_height =
      window.screen.availHeight * window.devicePixelRatio;

    this.global.aspect_ratio =
      this.global.canvas_width / this.global.canvas_height;
    ...
    if (this.global.aspect_ratio < 1)
      this.global.scale_ratio =
        this.global.canvas_height / this.global.canvas_height_max;
    else {
